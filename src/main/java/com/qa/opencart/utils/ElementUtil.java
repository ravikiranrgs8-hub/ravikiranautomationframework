...
public class ElementUtil {
	...
	@Step("Entering the value:{1} to the element{0}")
	public void doSendKeys(By locator, String value) {
		getElement(locator).sendKeys(value);
	}

	@Step("Clickin on the element: {0}")
	 ...
	 * @return
	 */
	@Step("wait for the visibility of the Element: {0} with the timeout:{1}")
	 ...
	 * Visibility means that the elements are not
	...
	@Story("Waiting for the page title: {0} and the time out is : {1}")
	...
	@Step("waiting for the URL:{0} and the timeout is :{1}")
